...
const Hero = () => {
  ...
  return <section className="relative bg-[#fbfbfb] overflow-hidden">
    ...
    <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
      <div className="text-center max-w-4xl mx-auto">
        ...
        <p className="text-base sm:text-xl text-gray-700 mb-8 leading-relaxed max-w-3xl mx-auto">
          Let our AI create invoices from simple text,generate payment reminders,and provide smart insights to help you manage your finanaces.
        </p>
    ...
    <div className="mt-12 sm:mt-16 relative max-w-5xl mx-auto">
      <img src={HERO_IMG} alt="Invoice App Screenshot" className="rounded-2xl shadow-2xl shadow-gray-300 border-4 border-gray-200/200" />
    </div>
    </div>
    </section>
